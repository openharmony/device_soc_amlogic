...
extern int aml_regmap_update_bits(u32 bus_type, unsigned int reg, unsigned int mask, unsigned int val);
/*
...
extern void aml_cbus_update_bits(unsigned int reg, unsigned int mask, unsigned int val);
...
extern void aml_aobus_update_bits(unsigned int reg, unsigned int mask, unsigned int val);
...
extern void aml_vcbus_update_bits(unsigned int reg, unsigned int mask, unsigned int val);
...
extern void aml_dosbus_update_bits(unsigned int reg, unsigned int mask, unsigned int val);
...
extern void aml_hiubus_update_bits(unsigned int reg, unsigned int mask, unsigned int val);
...
{
    return readl((vpp_base + (reg << 2L)));
}

static inline void aml_write_vcbus_s(unsigned int reg, unsigned int val)
{
    writel(val, (vpp_base + (reg << 2L)));
}

static inline void aml_vcbus_update_bits_s(unsigned int reg, unsigned int value, unsigned int start, unsigned int len)
{
