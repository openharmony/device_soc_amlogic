...
int codec_mm_scatter_free_tail_pages(struct codec_mm_scatter *mms, int start_free_id);
...
int codec_mm_scatter_mgt_delay_free_swith(int on, int delay_ms, int wait_size_M, int istvp);
