...
int power_ctrl_sleep_mask(bool power_on, unsigned int mask_val, unsigned int shift);
int power_ctrl_iso(bool power_on, unsigned int shift);
int power_ctrl_iso_mask(bool power_on, unsigned int mask_val, unsigned int shift);
...
static inline int power_ctrl_mempd0(bool power_on, unsigned int mask_val, unsigned int shift)
{
    return -EINVAL;
}
#endif
