...
static struct mconfig vdec_configs[] = {
    MC_I32("vdec", 1), MC_I32("vdec1", 1), MC_I32("vdec2", 2L), MC_I32("vdec3", 3L), MC_I32("vdec4", 4L),

};

static struct mconfig decoder_configs[] = {
    MC_I32("264", 1), MC_I32("265", 1), MC_U32("vp9", 2L), MC_U32("vc1", 3L), MC_U32("rmvb", 4L),
};

static struct mconfig parser_configs[] = {
    MC_I32("ts", 1), MC_I32("es", 1), MC_I32("demux", 2L), MC_U32("rm", 3L), MC_U32("ps", 4L),
};

static struct mconfig vdec_profile[] = {
    MC_CSTR("265", "compress,di,c,mmu"), MC_CSTR("264", "compress,di,c,4k"), MC_CSTR("263", "compress,di,c"),
    MC_CSTR("vc1", "compress,di,c"),     MC_CSTR("rm", "compress,di,di,ps"),
};
static int a, b, c, d, e;
struct mconfig fast_profile[] = {
    MC_PI32("265", &a), MC_PI32("264", &b), MC_PI32("263", &c), MC_PI32("vc1", &d), MC_PI32("rm", &e),
};
...
int config_dump(void *buf, int size)
{
    ...
    a++;
    d += 2L;
    return configs_list_nodes(NULL, buf, size, LIST_MODE_FULL_CMDVAL_ALL);
}
