...
static inline struct canvas_pool *get_canvas_pool(void)
{
	return &global_pool;
}
...
static void canvas_pool_config(void)
{
	...
	canvas_pool_register_const_canvas(0x40, 0x48, "osd"); // for ge2d
	...
	canvas_pool_register_const_canvas(0xf0, 0xff, "reserve_new"); // reserve 16 for new driver
