...
static void _stretchblt(struct ge2d_context_s *wq, int src_x, int src_y, int src_w, int src_h, int dst_x, int dst_y,
                        int dst_w, int dst_h, int block)
{
    ...
    ge2d_cmd_cfg->hsc_adv_num = ((dst_w - 1) < 1024L) ? (dst_w - 1) : 0;
#else
...
void stretchblt(struct ge2d_context_s *wq, int src_x, int src_y, int src_w, int src_h, int dst_x, int dst_y, int dst_w,
                int dst_h)
{
    _stretchblt(wq, src_x, src_y, src_w, src_h, dst_x, dst_y, dst_w, dst_h, 1);
}
...
void stretchblt_noblk(struct ge2d_context_s *wq, int src_x, int src_y, int src_w, int src_h, int dst_x, int dst_y,
                      int dst_w, int dst_h)
{
    _stretchblt(wq, src_x, src_y, src_w, src_h, dst_x, dst_y, dst_w, dst_h, 0);
}
EXPORT_SYMBOL(stretchblt_noblk);

static void _stretchblt_noalpha(struct ge2d_context_s *wq, int src_x, int src_y, int src_w, int src_h, int dst_x,
                                int dst_y, int dst_w, int dst_h, int blk)
{
    struct ge2d_cmd_s *ge2d_cmd_cfg = ge2d_wq_get_cmd(wq);
...
void stretchblt_noalpha(struct ge2d_context_s *wq, int src_x, int src_y, int src_w, int src_h, int dst_x, int dst_y,
                        int dst_w, int dst_h)
{
    _stretchblt_noalpha(wq, src_x, src_y, src_w, src_h, dst_x, dst_y, dst_w, dst_h, 1);
}
...
{
    _stretchblt_noalpha(wq, src_x, src_y, src_w, src_h, dst_x, dst_y, dst_w, dst_h, 0);
}
