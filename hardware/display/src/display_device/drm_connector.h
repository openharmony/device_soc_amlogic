...
private:
    ...
    uint32_t mPropDpmsId = 0xFFFFFFFF;
    uint64_t mDpmsState = 0;
    uint32_t mPropCrtcId = 0xFFFFFFFF;
    uint32_t mPropBrightnessId = 0xFFFFFFFF;
    uint32_t mBrightnessLevel = 0;
    std::unordered_map<int32_t, DrmMode> mModes;
    int32_t mPreferenceId = -1;
