...
uint32_t HdiLayer::GetIdleId()
{
    ...
    // ensure the mIdleId not 0xffffffff
    mIdleId = mIdleId % 0xffffffff;
    do {
...
int32_t HdiLayer::Init()
{
    ...
    DISPLAY_CHK_RETURN((id == 0xffffffff), DISPLAY_FAILURE, DISPLAY_LOGE("have no id to used"));
    mId = id;
